...
import GPy
from GPy.kern.ademu.kern import Kern
from GPy.kern.ademu.stationary import Stationary
...
from ademu.models.generation import ImpactSymmetricTC, Holland08
from ademu.constants import (
    DATA_PATH,
    FIGURE_PATH,
    NEW_ORLEANS,
    NO_BBOX,
...
from .generation import vmax_from_pressure_holliday
...
def diff_res(cfg: DictConfig) -> None:
    ...
    """
    python ademu/models/emu6d.py init_samples=29 active_samples=1 seed=1040 dryrun=false
    python ademu/models/emu6d.py init_samples=1 active_samples=29 seed=1061 dryrun=false
    python ademu/models/emu6d.py init_samples=15 active_samples=15 seed=1062 dryrun=false
    python ademu/models/emu6d.py init_samples=45 active_samples=15 seed=1173 dryrun=false
    python ademu/models/emu6d.py init_samples=15 active_samples=45 seed=1094 dryrun=false
    python ademu/models/emu6d.py init_samples=30 active_samples=30 seed=1095 dryrun=false
    python ademu/models/emu6d.py init_samples=59 active_samples=1 seed=1046 dryrun=false
    #
    python ademu/models/emu6d.py init_samples=1 active_samples=59 seed=1057 dryrun=false
    python ademu/models/emu6d.py init_samples=119 active_samples=1 seed=1048 dryrun=false
    python ademu/models/emu6d.py init_samples=1 active_samples=119 seed=1135 dryrun=false
    python ademu/models/emu6d.py init_samples=105 active_samples=15 seed=50 dryrun=false
    python ademu/models/emu6d.py init_samples=90 active_samples=30 seed=391 dryrun=false
    python ademu/models/emu6d.py init_samples=30 active_samples=90 seed=291 dryrun=false
    python ademu/models/emu6d.py init_samples=60 active_samples=60 seed=191 dryrun=false
    python ademu/models/emu6d.py init_samples=105 active_samples=15 seed=215 dryrun=false
    python ademu/models/emu6d.py init_samples=15 active_samples=105 seed=159 dryrun=false
    python ademu/models/emu6d.py init_samples=119 active_samples=1 seed=259 dryrun=false
    python ademu/models/emu6d.py init_samples=1 active_samples=119 seed=359 dryrun=false
    python ademu/models/emu6d.py init_samples=30 active_samples=30 seed=358 dryrun=false
    python ademu/models/emu6d.py init_samples=1 active_samples=59 seed=357 dryrun=false
    python ademu/models/emu6d.py init_samples=59 active_samples=1 seed=356 dryrun=false
    python ademu/models/emu6d.py init_samples=22 active_samples=8 seed=355 dryrun=false
    python ademu/models/emu6d.py init_samples=8 active_samples=22 seed=354 dryrun=false
    python ademu/models/emu6d.py init_samples=75 active_samples=45 seed=343 dryrun=false
    python ademu/models/emu6d.py init_samples=300 active_samples=1 seed=401 dryrun=false
    python ademu/models/emu6d.py init_samples=15 active_samples=15 seed=402 dryrun=false
    python ademu/models/emu6d.py init_samples=600 active_samples=1 seed=403 dryrun=false
    python ademu/models/emu6d.py init_samples=900 active_samples=1 seed=404 dryrun=false
    python ademu/models/emu6d.py init_samples=1 active_samples=119 seed=1100 dryrun=false
    """
...
def find_max(cfg: DictConfig) -> None:
    ...
    print("end")
    """
    python ademu/models/emu6d.py place=ansley seed=50
    python ademu/models/emu6d.py place=new_orleans seed=60
    python ademu/models/emu6d.py place=diamondhead seed=70
    python ademu/models/emu6d.py place=mississippi seed=80
    #
    python ademu/models/emu6d.py place=atchafayala seed=90
    python ademu/models/emu6d.py place=dulac seed=100
    python ademu/models/emu6d.py place=akers seed=110

    """


if __name__ == "__main__":
    # python ademu/models/emu6d.py samples=100 seed=31 dryrun=true
    # lhs()
    # combine_lhs()
    find_max()
