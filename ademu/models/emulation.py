...
from .generation import ImpactSymmetricTC, Holland08
from ..constants import DATA_PATH, FIGURE_PATH, NEW_ORLEANS, NO_BBOX, PLACES_D
...
if __name__ == "__main__":
    # python ademu/models/emulation.py
    # example_animation()
    # example_plot()
    plot_defaults()
    # mat32mvesno()
